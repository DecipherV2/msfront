...
const Shopping = lazy(() => import('../../views/apps/ecommerce/shopping'))
const Panier = lazy(() => import('../../views/apps/ecommerce/shopping'))
const Detail = lazy(() => import('../../views/apps/ecommerce/detail'))
